...
<nav class="navbar navbar-expand-lg bg-light navbar-light">
  ...
  <!-- Collapse button -->
    ...
    <form class="form-inline">
      <div class="md-form my-0" style="margin-left: 68%;">
        <input class="form-control mr-sm-2" style="width:452%" type="text" placeholder="Search for Perfect Jewelry" aria-label="Search">
      </div>
    </form>
  ...
  <div class="collapse navbar-collapse" id="basicExampleNav">
    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        ...
        <a class="nav-link" href="#"><span class="glyphicon glyphicon-heart"></span>
        WISHLIST</a>
      </li>
